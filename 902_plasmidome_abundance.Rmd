...
defense_path <- "Collect/overview/plasmidome_circular_padloc.csv"
...
for (i in seq_along(plot_names)) {
  ...
  print(p)
  ggsave(
    filename = paste0("Results/03.abundance of defense systems/Defense_System_Distribution_by_", plot_names[i], ".pdf"),
    plot = p,
    width = 10,
    height = 10,
    dpi = 300
