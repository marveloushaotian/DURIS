...
p <- ggplot(plot_data, aes(x = NMDS1, y = NMDS2, color = Location, shape = Country)) +
  geom_point(size = 3) +
  ...
  scale_color_manual(values = c("#dc5772", "#6566aa", "#f07e40", "#8fced1", "#dc5772", "#6566aa", "#f07e40", "#8fced1")) +
