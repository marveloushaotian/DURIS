...
# Setup logging
logging.basicConfig(filename='rename_headers.log', level=logging.INFO,
...
def rename_headers(input_file, output_file):
    ...
    try:
        ...
        logging.info("Header renaming completed successfully.")
    except Exception as e:
        logging.error(f"Error during header renaming: {e}")
        raise
