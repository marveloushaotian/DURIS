...
def main():
    parser = argparse.ArgumentParser(description='Process a CSV file to remove duplicate headers, metadata, and entries based on specified fields.',
                                     epilog='Example usage: python process_csv.py -i example_data.csv -o cleaned_data.csv')
