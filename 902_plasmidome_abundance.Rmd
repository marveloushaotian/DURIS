...
defense_path <- "Collect/defense/new_test_2.txt"

metadata_df <- read_excel(metadata_path)
defense_df <- read.table(defense_path)
...
for (i in seq_along(plot_names)) {
  ...
  print(p)
  ggsave(
    filename = paste0("Results/03.abundance of defense systems/plasmidome_Defense_System_Distribution_by_", plot_names[i], ".pdf"),
    plot = p,
    width = 10,
    height = 10,
    dpi = 300
